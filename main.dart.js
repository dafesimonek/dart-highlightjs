...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JavaScriptObject: {
      ...
      initHighlighting$0: function(receiver) {
        return receiver.initHighlighting();
      },
      listLanguages$0: function(receiver) {
        return receiver.listLanguages();
      },
      $isJSObject: 1
    },
    ...
    "^": "",
    main: [function() {
      var highlighter, showLanguages, t1;
      highlighter = H.interceptedTypeCast(document.querySelector("#highlight"), "$isButtonElement");
      showLanguages = H.interceptedTypeCast(document.querySelector("#showLanguages"), "$isButtonElement");
      highlighter.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(highlighter, "click", false), [null]);
      ...
      showLanguages.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(showLanguages, "click", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    main_closure: {
      "^": "Closure:2;",
      call$1: function(evt) {
        J.initHighlighting$0$x(self.hljs);
      }
    },
    main_closure0: {
      "^": "Closure:2;",
      call$1: function(evt) {
        window.alert("Default supported languages: " + J.join$1$ax(J.listLanguages$0$x(self.hljs), ", "));
      }
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  J.initHighlighting$0$x = function(receiver) {
    return J.getInterceptor$x(receiver).initHighlighting$0(receiver);
  };
  J.join$1$ax = function(receiver, a0) {
    return J.getInterceptor$ax(receiver).join$1(receiver, a0);
  };
  J.listLanguages$0$x = function(receiver) {
    return J.getInterceptor$x(receiver).listLanguages$0(receiver);
  };
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}];
